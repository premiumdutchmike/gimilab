...
export async function proxy(request: NextRequest) {
  ...
  const publicPaths = ['/', '/pricing', '/about', '/blog', '/press', '/careers', '/help', '/contact', '/partner', '/partners', '/partner/apply', '/signup', '/login', '/welcome', '/waitlist', '/vs-golfnow', '/vs-teetimegolfpass']
