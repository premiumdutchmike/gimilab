  ...
  return (
    <div style={{ padding: '32px 28px', maxWidth: 900, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <a href="/admin/outreach/prospects" style={{ fontSize: 12, color: 'var(--stone)', textDecoration: 'none' }}>
          &larr; Prospects
        </a>
      </div>
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontSize: 26, fontWeight: 900, color: 'var(--linen)', letterSpacing: '-0.03em', lineHeight: 1, marginBottom: 4 }}>
          {prospect.courseName}
        </h1>
