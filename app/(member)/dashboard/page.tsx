    ...
    <>
      ...
      <style>{`
        ...
        .lab-activity-row {
          ...
          gap: 16px;
          padding: 9px 0;
          border-bottom: 1px solid rgba(12,12,11,0.05);
        }
        ...
        .lab-search-input:focus { border-color: rgba(191,123,46,0.4); }
        .lab-search-hints {
          display: flex;
          flex-wrap: wrap;
          gap: 6px;
        ...
        .lab-hint-chip:hover { color: #0C0C0B; }
        .lab-hint-chip::after { content: ' ·'; color: rgba(12,12,11,0.2); }
